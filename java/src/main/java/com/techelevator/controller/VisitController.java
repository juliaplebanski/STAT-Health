...
public class VisitController {
	...
	public List<Visit> getAllAvailableVisitsByDoctorId(@PathVariable int patientId, @PathVariable int doctorId,
			@PathVariable String dateOfVisit) {
	...
	@RequestMapping(path = "/visits/{patientId}", method = RequestMethod.GET)
	public List<Visit> retrieveListOfPreviousAppointments(@PathVariable int patientId) {
		return visitDao.retrieveListOfPreviousAppointments(patientId);
